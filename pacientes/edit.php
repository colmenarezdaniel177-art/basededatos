            ...
            <form method="POST">
              <div class="row g-3">
                ...
                <div class="col-md-6">
                  ...
                  <input type="text" name="cedula" pattern="\d+"  maxlength="8" 
                    minlength="8" title="Solo se permiten números (máximo 8 dígitos)" class="form-control" placeholder="Ej. 12345678" value="<?= e($p['cedula'] ?? '') ?>">
                </div>
                <div class="col-md-6">
