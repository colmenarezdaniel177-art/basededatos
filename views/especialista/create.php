<?php
$title = "Crear Nuevo Especialista";
    ...
    <div class="col-md-6">
        <div class="card-header d-flex justify-content-between align-items-center">
            <h4 class="card-title mb-0">
                <i class="fas fa-user-md me-2"></i>Crear Especialista
            </h4>
        ...
        <div class="card-body">
            ...
            <?php endif; ?>
            <form method="POST" action="index.php?controller=especialista&action=create" id="especialistaForm">
                <div class="row">
                    <div class="col-md-9">
